    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl px-6 py-4 shadow-sm">
                ...
                <div className="flex items-end gap-2">
                  ...
                  <span className="text-xs text-green-600 bg-green-50 px-2 py-1 rounded mb-1">
                    +12%
                  </span>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="flex items-center justify-center">
                <div className="text-center">
                  <div className="mb-4">
                    <div className="w-32 h-32 mx-auto bg-gradient-to-br from-amber-600 to-amber-800 rounded-full flex items-center justify-center">
                      <Building2 className="w-16 h-16 text-white" />
                    </div>
                  </div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-1">Prestige</h2>
                  <h3 className="text-2xl font-semibold text-gray-700 mb-2">GROUP</h3>
                  <p className="text-sm text-gray-500 italic">Add Prestige to your life</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-blue-500 rounded-2xl p-6 text-white shadow-lg">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold mb-1">280+</div>
            ...
            <div className="bg-green-500 rounded-2xl p-6 text-white shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="text-xl font-medium">Upcoming Projects</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm text-center">
                <div className="text-5xl font-bold text-purple-500 mb-2">37+</div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm text-center">
                ...
                <div className="text-sm text-gray-500">Cities Presence</div>
              </div>
            </div>

            {/* Mission */}
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3 text-center">Our Mission</h3>
            ...
            {/* Vision */}
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3 text-center">Our Vision</h3>
              <p className="text-sm text-gray-600 text-center leading-relaxed">
            ...
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-1">The Prestige City Hyderabad</h3>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 bg-gray-50 rounded-xl">
                    <Home className="w-5 h-5 text-gray-400 mx-auto mb-2" />
                    <div className="text-sm text-gray-500 mb-1">Total Units</div>
                    <div className="text-xl font-semibold text-gray-900">405</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-xl">
                    <Building2 className="w-5 h-5 text-gray-400 mx-auto mb-2" />
                    <div className="text-sm text-gray-500 mb-1">Project Size</div>
                    <div className="text-xl font-semibold text-gray-900">4 Acre</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-xl">
                    <Calendar className="w-5 h-5 text-gray-400 mx-auto mb-2" />
                    <div className="text-sm text-gray-500 mb-1">Launch Date</div>
                    <div className="text-xl font-semibold text-gray-900">Aug 2024</div>
                  </div>
                </div>

                {/* Tags */}
                <div className="flex gap-2 mb-6">
                  <span className="px-3 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">3 BHK</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">4 BHK</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">5 BHK</span>
                </div>

                {/* Deals Section */}
                <div className="border-t pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-gray-900">Deals</h4>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex-1">
                      <div className="bg-green-500 text-white rounded-xl p-4 text-center">
                        ...
                        <div className="text-sm opacity-90">Closed Deals</div>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="font-medium text-gray-900">Sep 2028</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="font-medium text-gray-900">1,200 - 3,000 sqft</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    <div className="text-sm text-gray-500 mb-1">Total Range</div>
                    <div className="text-2xl font-bold text-gray-900">₹1.18 Cr - ₹2.91 Cr</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-5">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About the Builder</h2>
              ...
              <div className="col-span-3 flex items-start justify-center">
                <div className="text-center">
                  <div className="w-40 h-48 rounded-2xl overflow-hidden mb-4 bg-gradient-to-br from-gray-100 to-gray-200">
                    <img
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Irfan Razack</h3>
                  <p className="text-xs text-gray-600 mb-3">Chairman & Managing Director</p>
              ...
              <div className="col-span-4">
                <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-xl p-6">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs text-teal-700 mb-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex gap-2">
                      <input
                        type="text"
                        placeholder="+91"
                        className="w-16 px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white"
                      />
                      <input
                        type="tel"
                        placeholder="Phone Number"
                        className="flex-1 px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white"
                      />
                    </div>
                  ...
                  {/* Team Members */}
                  <div className="flex items-center justify-center gap-4 pt-4 border-t border-teal-100">
                    <div className="text-center">
                      <div className="w-14 h-14 rounded-full overflow-hidden mb-1.5 mx-auto border-2 border-white">
                        <img
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 rounded-full overflow-hidden mb-1.5 mx-auto border-3 border-teal-500">
                        <img
        ...
        <div className="mt-8">
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">OPERATIONAL SEGMENTS</h2>
              <h3 className="text-3xl font-bold text-teal-600">Projects</h3>
            </div>

            <div className="flex gap-4 mb-6 text-sm">
              <button className="px-4 py-2 bg-teal-600 text-white rounded-lg font-medium">RESIDENTIAL</button>
              <button className="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">COMMERCIAL</button>
              <button className="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">HOSPITALITY</button>
              <button className="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">RETAIL</button>
            </div>
            ...
            <div className="grid grid-cols-6 gap-6">
              {[
                ...
                <div key={index} className="text-center">
                  <div className="w-20 h-20 rounded-full overflow-hidden mx-auto mb-2 border-2 border-gray-200 hover:border-teal-500 transition-colors cursor-pointer">
                    <img
                      src={project.img}
                      alt={project.name}
                      className="w-full h-full object-cover"
        ...
        <div className="mt-8 grid grid-cols-12 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="relative w-40 h-40 mx-auto mb-6">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <div className="text-3xl font-bold text-gray-900">$32,021</div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900">$12,167</div>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <Calendar className="w-4 h-4 text-gray-400" />
                  ...
                  <div className="text-lg font-bold text-gray-900">$14,900</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-3">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-gray-900">Reminder</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer">
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900 mb-1">Follow-Ups</h4>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer">
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900 mb-1">Visits</h4>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer">
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900 mb-1">Expire Listings</h4>
          ...
          <div className="col-span-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">The Somerset</h3>
              ...
              <div className="grid grid-cols-5 gap-3 mb-6">
                ...
                <div className="col-span-2 flex items-center justify-between">
                  <div className="flex-1 bg-green-500 text-white rounded-lg p-3 text-center mr-2">
                    <div className="text-2xl font-bold mb-1">42</div>
                    <div className="text-xs opacity-90">Closed Deals</div>
                  </div>
                  <div className="flex-1 text-center">
                    <div className="text-2xl font-bold text-gray-900 mb-1">132</div>
              ...
              <div className="grid grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900">5 Bed</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Bath className="w-5 h-5 text-gray-400" />
                  <div>
                    <div className="text-sm font-semibold text-gray-900">3 Bath</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <SquareIcon className="w-5 h-5 text-gray-400" />
                  <div>
                    <div className="text-sm font-semibold text-gray-900">44 m2 Property Area</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Building2 className="w-5 h-5 text-gray-400" />
                  <div>
                    <div className="text-sm font-semibold text-gray-900">2025 year Build</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Active Listing</h3>
                <div className="flex items-center gap-3">
                  <div className="relative">
          ...
          <div className="col-span-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900">Kristian Wu</h4>
                    <p className="text-sm text-gray-500">House - Buy</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <button className="p-2 hover:bg-gray-100 rounded-lg">
              ...
              <div className="mt-4 flex items-center justify-between">
                <div>
                  <div className="text-3xl font-bold text-gray-900">$1,560,400</div>
                  <div className="text-xs text-gray-500 mt-1">Last Contacted: 1 Jun 2025</div>
                </div>
                <div className="text-right">
                  <span className="px-4 py-2 bg-green-500 text-white text-sm rounded-lg font-medium">
                    Closed Won
                  </span>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900">Kristina M.</h4>
                    <p className="text-sm text-gray-500">Apartment - Buy</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <button className="p-2 hover:bg-gray-100 rounded-lg">
              ...
              <div className="mt-4 flex items-center justify-between">
                <div>
                  <div className="text-3xl font-bold text-gray-900">$500K - $650K</div>
                  <div className="text-xs text-gray-500 mt-1">Last Contacted: 1 Jun 2025</div>
                </div>
                <div className="text-right">
                  <span className="px-4 py-2 bg-teal-500 text-white text-sm rounded-lg font-medium">
                    New Lead
                  </span>
                  <div className="text-xs text-teal-600 mt-2 flex items-center justify-end gap-1">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-7 gap-2 text-center">
                  {[8, 9, 10, 11, 12, 13, 14].map((date) => (
                    <div
                      key={date}
                      className={`p-2 text-sm rounded-lg ${date === 10
              ...
              <div className="flex gap-4 mb-4 border-b">
                <button className="pb-2 text-sm font-semibold text-teal-600 border-b-2 border-teal-600">
                  All
                </button>
        ...
        <div className="mt-8">
          ...
          <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-purple-600 rounded-t-2xl p-12">
            <div className="flex items-center gap-8">
              {/* Logo */}
              <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center flex-shrink-0 shadow-lg">
                <Building2 className="w-16 h-16 text-indigo-600" />
              </div>

              {/* Company Info */}
              <div className="text-white">
                <h2 className="text-5xl font-bold mb-3">Prestige Group</h2>
                <p className="text-xl italic mb-6 opacity-90">&quot;Building Dreams, Creating Landmarks&quot;</p>
                <div className="flex gap-6">
                  <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-6 py-3">
                    <div className="text-sm opacity-90 mb-1">Founded</div>
                    <div className="text-2xl font-bold">1986</div>
                  </div>
                  <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-6 py-3">
                    <div className="text-sm opacity-90 mb-1">Headquarters</div>
          ...
          {/* White About Section */}
          <div className="bg-white rounded-b-2xl p-12 shadow-sm">
            <div className="grid grid-cols-12 gap-12">
              {/* Left - About Text */}
              <div className="col-span-8">
                <h3 className="text-3xl font-bold text-gray-900 mb-6">About the Builder</h3>
              ...
              <div className="col-span-4">
                <div className="bg-gray-50 rounded-2xl p-8 text-center">
                  <div className="w-32 h-32 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full mx-auto mb-6 flex items-center justify-center overflow-hidden">
                    <img
                  ...
                  <h4 className="text-2xl font-bold text-gray-900 mb-2">Irfan Razack</h4>
                  <p className="text-sm text-indigo-600 font-medium mb-6">Chairman & Managing Director</p>
