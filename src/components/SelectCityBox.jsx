...
export default function SelectCityBox({ title = "Select by City", cities = [] }) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row" ref={sectionRef}>
      {/* Mobile View (425px and below) - Background with centered content */}
      <div className="max-[425px]:block hidden w-full relative min-h-screen bg-cover bg-center bg-no-repeat"
           style={{
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full px-4">
          ...
          {/* City Icons - Horizontal Scrolling */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
            <div className="flex overflow-x-auto gap-4 scrollbar-hide pb-2">
              {cities.map((city, index) => (
                ...
                >
                  <div className="w-16 h-16 rounded-full border-2 overflow-hidden bg-white transition-all duration-200 hover:scale-110" style={{ borderColor: '#f9c12f' }}>
                    <Image
                      src={city.image}
                      alt={city.name}
                      width={64}
      ...
      {/* Desktop View (above 425px) - Original Design */}
