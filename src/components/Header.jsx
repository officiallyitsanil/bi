...
export default function Header() {
    ...
    const navLinks = [
        ...
        { href: '/buy-properties', label: 'Buy Properties' },
        { href: '/sell-properties', label: 'Sell Properties' },
        { href: '/subscribe', label: 'Premium', icon: <Image src="/crown.svg" alt="Crown" width={24} height={24} /> },
    ];
